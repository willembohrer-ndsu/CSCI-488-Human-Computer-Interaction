...
INSERT INTO CLASS (PROFESSOR_ID, ROOM_SCHEDULE_ID, NAME, NUMBER, CREATEDON, CREATEDBY, LASTUPDATEON, LASTUPDATEDBY, ACTIVE)
  VALUES (1, 1, 'CSCI 160', '160', NOW()::TIMESTAMPTZ(0), 'willembohrer', NOW()::TIMESTAMPTZ(0), 'willembohrer', TRUE);
INSERT INTO CLASS (PROFESSOR_ID, ROOM_SCHEDULE_ID, NAME, NUMBER, CREATEDON, CREATEDBY, LASTUPDATEON, LASTUPDATEDBY, ACTIVE)
  VALUES (2, 2, 'CSCI 161', '161', NOW()::TIMESTAMPTZ(0), 'willembohrer', NOW()::TIMESTAMPTZ(0), 'willembohrer', TRUE);

...
CALL LOG_ATTENDANCE('NATHAN.MARCOTTE@NDSU.EDU', 'Nathan Class', 'Class #', Class, '00:01', '02:00', 5, 'Tuesday'); COMMIT;
CALL CREATE_CLASS(CAST('NATHAN.MARCOTTE@NDSU.EDU' AS TEXT), CAST('Nathan Class' AS VARCHAR), CAST('NUMBER #' AS VARCHAR), {12}, CAST('01:00' AS TIME), CAST('01:00' AS TIME), '{MONDAY}', {4}); COMMIT;
  24 hour time
*/
